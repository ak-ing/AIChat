...
import com.aking.aichat.ui.helper.SimpleImeAnimationController
import com.aking.aichat.utl.suppressLayoutCompat
 ...
 * if desired.
 */
class InsetsAnimationCoordinatorLayout @JvmOverloads constructor(
    ...
    override fun onNestedPreScroll(target: View, dx: Int, dy: Int, consumed: IntArray, type: Int) {
        ...
        if (deltaY < 0) {
            ...
            } else if (scrollImeOffScreenWhenVisible && !imeAnimController.isInsetAnimationRequestPending() && ViewCompat.getRootWindowInsets(
                    this
    ...
    override fun onNestedFling(
        ...
        if (imeAnimController.isInsetAnimationInProgress()) {
            ...
            when {
                velocityY > 50 && scrollImeOnScreenWhenNotVisible && !imeVisible -> {
                ...
                velocityY < 50 && scrollImeOffScreenWhenVisible && imeVisible -> {
    ...
    private fun startControlRequest() {
        ...
        imeAnimController.startControlRequest(view = this, onRequestReady = { onControllerReady() })
    }
