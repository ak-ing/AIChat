package com.aking.aichat.model.binder.base
...
import android.os.*
import com.aking.aichat.model.binder.listener.IServiceConnectListener
...
abstract class BaseConnectManager<T : IInterface> {
    ...
    private fun bindService() {
        if (mProxy == null) {
            ...
            val connected =
                mApplication.bindService(intent, mServiceConnection, Context.BIND_AUTO_CREATE)
